...
- **2026-08-14** — Added a **"live portfolios" strip** under the hero linking the two new WebGL portfolios built from the MengTo/kage single-file experience: **Temple** (https://yaleedhaque.github.io/portfolio, repo `yaleedhaque/portfolio`) and **Local network** (https://yaleedhaque.github.io/portfolio-hw, repo `yaleedhaque/portfolio-hw`). Each is a self-contained WebGL portfolio (Onest YALEED wordmark — the embedded Wordmark subset only has A/E/K/G, so the 3D wordmark uses Onest 700) with all 9 projects across 4 scroll chapters.
- **2026-08-14** — Projects **8 → 9**: added **OmniFetch-Android** (P9, Android app — search/stream/download YouTube on-device with bundled yt-dlp + ffmpeg, Kotlin/Compose/Media3, v1.0.0). New download-into-phone `.card-icon`; stats 8 → 9, narrative "Nine projects live", terminal `projects` array + footer Code column updated; meta/og descriptions 8 → 9.
